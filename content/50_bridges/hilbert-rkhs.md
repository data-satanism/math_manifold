...
![Функция раскладывается на оболочку ядерных сечений и ортогональную часть; матрица Грама связывает эту геометрию с ядерным прогнозом и неопределённостью гауссовского процесса](80_assets/bridges/gpt-image-v3/hilbert-rkhs-representer-v3.png)
