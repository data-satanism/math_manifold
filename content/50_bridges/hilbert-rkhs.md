...
> [!info] established
> Непрерывность функционалов вычисления значения и положительная полуопределённость ядра дают гильбертову геометрию. Теорема о представителе сводит решение регуляризованной задачи к оболочке ядерных сечений обучающих точек.

![Функция раскладывается на оболочку ядерных сечений и ортогональную часть; матрица Грама связывает эту геометрию с ядерным прогнозом и неопределённостью гауссовского процесса](80_assets/bridges/gpt-image-v3/hilbert-rkhs-representer-v3.webp)

Ортогональная часть не меняет значения функции на обучающих точках, но увеличивает норму, поэтому минимум лежит в конечномерной оболочке ядерных сечений. Отрицательное собственное значение матрицы Грама разрушает эту интерпретацию.
