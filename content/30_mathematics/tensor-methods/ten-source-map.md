...
| kolda-bader-tensors-2009 | 2. Нотация и предварительные сведения: волокна и срезы, тензоры ранга один, симметрия, диагональные тензоры, матризация и произведения | PDF 3–9 | ten-01-multilinear-objects |
| kolda-bader-tensors-2009 | 3. CP: ранг и граничный ранг, единственность, алгоритмы, вычислительные сложности и приложения | PDF 9–25 | ten-02-cp-rank;ten-05-identifiability-degeneracy |
| kolda-bader-tensors-2009 | 4. Tucker: сжатие, многолинейный ранг, HOSVD/HOOI, вычисления и приложения | PDF 25–36 | ten-03-tucker-hosvd |
...
| halko-randomized-matrices-2011 | 1. Введение: двухэтапная схема, фиксированный ранг или точность, случайная выборка, степенная итерация | PDF 1–10 | ten-06-randomized-range-finding |
| halko-randomized-matrices-2011 | 2–3. Обозначения, детерминированная схема и преобразование базиса в разложения | PDF 10–20 | ten-06-randomized-range-finding |
| halko-randomized-matrices-2011 | 4–7. Рандомизированное нахождение образа, оценивание ошибки, разложения SVD, ID и CUR, однопроходные и другие варианты | PDF 20–38 | ten-06-randomized-range-finding;ten-07-completion-cur-sampling |
| halko-randomized-matrices-2011 | 8–11. Вероятностный анализ гауссовых схем, степенная итерация и режим заданной точности | PDF 38–63 | ten-06-randomized-range-finding |
