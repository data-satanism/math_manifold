...
![Локальный конечно-элементный базис задаёт приближение, а невязка ортогональна всем тестовым модам](80_assets/numerical-analysis/gpt-image-v6/galerkin-finite-elements-residual-v6.png)
