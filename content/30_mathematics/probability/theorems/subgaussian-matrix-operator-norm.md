...
![Теорема об операторной норме: сетка направлений, компенсация числа проверок хвостом, аналогия с испытаниями конструкции, спектральный перенос и отказ при ненулевом среднем](80_assets/probability/gpt-image-v2/subgaussian-matrix-operator-norm-insight-v2.png)
