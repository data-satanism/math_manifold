...
![Концепция теоремы: случайная матрица Грама заменяется эффективным ядром, а регуляризация управляет критической областью](80_assets/random-matrix-theory/gpt-image-v3/random-feature-gram-insight-v3.png)
