...
| gdl-protobook-2021 | 5. Модели GDL: 5.1 CNN; 5.2 G-CNN; 5.3 GNN; 5.4 Deep Sets, Transformers и латентные графы; 5.5 эквивариантная передача сообщений; 5.6 intrinsic mesh CNN; 5.7 RNN; 5.8 LSTM | PDF 72–105 | gdl-05-equivariant-operators-convolution;gdl-10-message-passing-expressivity;gdl-11-grids-cnn-equivariance;gdl-12-homogeneous-spaces-geometric-graphs |
...
| gdl-math-foundations-2025 | 4. Топология и дифференциальная геометрия: 4.1 топология; 4.2 эквивалентности; 4.3 многообразия; 4.4 manifold hypothesis | PDF 37–50 | gdl-06-smooth-manifolds-tangent-bundles;gdl-07-riemannian-metric-geodesics |
...
| deep-sets-2017 | 1–5. Введение; перестановочная инвариантность и эквивариантность; архитектура Deep Sets; приложения; выводы. Приложения A–I: доказательства, invariant/equivariant model и эксперименты | PDF 1–29 | gdl-03-orbits-stabilizers-quotients;gdl-10-message-passing-expressivity |
...
| gauge-mesh-cnn-2021 | 1–6. Введение; калибровки на сетках; gauge-equivariant convolution; parallel transport/message passing; эксперименты; обсуждение и приложения | PDF 1–17 | gdl-08-connections-gauges;gdl-12-homogeneous-spaces-geometric-graphs |
...
| equivariant-universal-approximation-2018 | 3. Трансляции: конечные абелевы группы; непрерывные сигналы; pooling | PDF 18–32 | gdl-05-equivariant-operators-convolution;gdl-11-grids-cnn-equivariance |
| equivariant-universal-approximation-2018 | 4. Charge-conserving convnets: pointwise equivariance; дифференцирование; дискретные операторы; SO(2)-модули; основная теорема | PDF 32–56 | gdl-12-homogeneous-spaces-geometric-graphs |
